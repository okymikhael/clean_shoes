...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900"
        style="background: url(/storage/sitemanagement/background.jpg); background-size: 100% 100%;" :class="{ 'overflow-hidden': isSideMenuOpen }">
        <!-- Desktop sidebar -->
        <aside class="z-20 hidden w-64 overflow-y-auto bg-white bg-opacity-90 dark:bg-gray-800 md:block flex-shrink-0">
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul>
                    ...
                    @can('activity-list')
                    <li class="relative px-6 py-3">
                        @if(Request::is('booking-administrasion'))
                        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                            aria-hidden="true"></span>
                        @endif
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            href="/booking-administrasion">
                            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                <path
                            ...
                            <span class="ml-4">Aktivitas Peminjaman</span>
                        </a>
                    </li>
                    @endcan
                    @can('admin-list')
        ...
        <div class="flex flex-col flex-1 w-full">
            <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800 bg-opacity-90">
                <div
